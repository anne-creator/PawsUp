...
export const HeaderClass = connect(mapStateToProps, mapDispatchToProps)(withTranslation()(withRouter(HeaderComponent)))//两个括号叠加在一起：// inject state into the componnet using connect
