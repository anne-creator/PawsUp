...
exports.HeaderClass = function () {
    ...
    react_1["default"].createElement("div", { className: Header_module_scss_1["default"]["app-header"] },
        ...
        react_1["default"].createElement(Layout.Header, { className: Header_module_scss_1["default"]["main-header"] },
            react_1["default"].createElement("span", { onClick: function () { return history.push("/"); } },
                react_1["default"].createElement("img", { src: logo_svg_1["default"], alt: "logo", className: Header_module_scss_1["default"]["App-logo"] }),
                react_1["default"].createElement(Typography.Title, { level: 3, className: Header_module_scss_1["default"].title }, t("header.title"))),
            react_1["default"].createElement(Input.Search, { placeholder: "请输入旅游目的地、主题、或关键字", className: Header_module_scss_1["default"]["search-input"], onSearch: function (keywords) { return history.push("/search/" + keywords); } })),
