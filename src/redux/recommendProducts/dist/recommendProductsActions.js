...
exports.giveMeDataActionCreator = exports.fetchRecommendProductFailActionCreator = exports.fetchRecommendProductSuccessActionCreator = exports.fetchRecommendProductStartActionCreator = exports.FETCH_RECOMMEND_PRODUCTS_FAIL = exports.FETCH_RECOMMEND_PRODUCTS_SUCCESS = exports.FETCH_RECOMMEND_PRODUCTS_START = void 0;
...
exports.giveMeDataActionCreator = function () { return function (dispatch, getState) { return __awaiter(void 0, void 0, void 0, function () {
    var data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                data = (_a.sent()).data;
                dispatch(exports.fetchRecommendProductSuccessActionCreator(data));
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                dispatch(exports.fetchRecommendProductFailActionCreator(error_1.message));
                return [3 /*break*/, 3];
